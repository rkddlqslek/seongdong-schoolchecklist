...
const NAV_STRUCTURE = [
  {
    ...
    floors: [
      ...
      { floor: "2층", rooms: ["위센터","4-1반","방과후교실1","메이커실","창의융합실","컴퓨터실 및 컴퓨터준비실","수석교사실","자치회의실","수업나눔실","실과실","교사연구실"] },
  ...
  },
  {
    ...
    floors: [
      ...
      { floor: "2층", rooms: ["도서관","wee클래스","3-1반","3-2반","늘봄(다온반)","열린반","교사연구실"] },
      { floor: "3층", rooms: ["강당","체육실","전담실(체육)","5-1반","5-2반"] }
    ]
  },
  {
    building: "통학로",
